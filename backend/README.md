...
## Project Structure
    ...
    ├── testapiautoconnecto_57799  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_57799`
...
2. Clone this repo and `cd testapiautoconnecto_57799`
